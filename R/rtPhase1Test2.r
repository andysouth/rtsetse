#' an a-spatial tsetse popn simulation, a second test of phase1 with an alternative density dependence mechanism
#'
#' \code{rtPhase1Test2} runs an a-spatial popn simulation as a test of phase 1
#' model components. It applies density-dependent pupal mortality following Rogers(1990).  
#' Some arguments related to density dependence may not be needed and are marked DEPRECATED.
...
#' @param propMortAdultDD DEPRECATED proportion of adult mortality that is density dependent
#' @param pMortPupa pupal mortality per period
#' @param propMortPupaDD DEPRECATED proportion of pupal mortality that is density dependent
...
rtPhase1Test2 <- function( iDays = 30,
                          iMaxAge = 120,
                          iCarryCap = 200,
                          iStartAdults = 200,
                          iStartAges = 1,
