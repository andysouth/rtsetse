...
Now adding together the 2 vegetation effects (i.e. on movement rates and reduced movement to less preferred).

```{r, "movement-serengeti3-both-veg-effects", eval=TRUE, echo=TRUE, message=FALSE, fig.width=7}
